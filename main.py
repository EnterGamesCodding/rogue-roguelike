...
class Game:
    ...
    def update(self, dt):
        ...
        if self.state == "playing":
            ...
            self.player.update(dt, pygame.key.get_pressed(), self.enemies, self.arena_rect, self.all_particles)
    ...
    def run(self):
        print("Game window opened. Press SPACE on the game window to start.")
        while self.running:
