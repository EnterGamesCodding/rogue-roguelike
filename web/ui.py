...
class HUD:
    ...
    def draw_victory(self, screen):
        ...
        draw_text(screen, "You survived 30 waves!", FONT_LG, NEON_GREEN, WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 + 10)
...
class StartScreen:
    def draw(self, screen):
        ...
        lines = [
            ...
            "Attack: -10% HP    |    Shield: 5s invulnerability    |    Teleport: -20% weakness 3s",
            "",
